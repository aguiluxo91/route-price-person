                ...
                <div key={i} className="card m-3">
                    ...
                    <div className="card-body">
                        <blockquote className="blockquote mb-0">
                            <p className='fw'>{capitalizeFirstLetter(fuelStation.Dirección.toLowerCase())}</p>
                            <p className='text-muted fs-6'>{fuelStation.Horario}</p>
                            {fuelStation["Precio Gasoleo A"] &&
                                <p className='fw-light fs-6'>Precio Gasoleo A <span className='fw-semibold'>{fuelStation["Precio Gasoleo A"]} €</span></p>
                            }

                            {fuelStation["Precio Gasolina 95 E5"] &&
                                <p className='fw-light fs-6'>Precio Gasolina 95 <span className='fw-semibold'>{fuelStation["Precio Gasolina 95 E5"]} €</span></p>
                            }
